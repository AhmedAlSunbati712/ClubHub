...
export default function CreateLocationModal({ open, onClose, onSubmit, isSubmitting = false }) {
  ...
  return (
    <Modal open={open} onClose={close} title="Create Location" labelledBy="create-location-title">
